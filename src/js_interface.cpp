...
EMSCRIPTEN_BINDINGS(adjacent_api) {
  ...
  class_<Constraint>("Constraint")
      .smart_ptr<std::shared_ptr<Constraint>>("Constraint");

  class_<ValueConstraint, base<Constraint>>("ValueConstraint")
      .smart_ptr<std::shared_ptr<ValueConstraint>>("ValueConstraint");

  class_<PointOnConstraint, base<ValueConstraint>>("PointOn")
      .smart_ptr_constructor("PointOn", &std::make_shared<PointOnConstraint, std::shared_ptr<PointE>, EntityPtr>);
      // .constructor<std::shared_ptr<PointE>, EntityPtr>();

  class_<LengthConstraint, base<ValueConstraint>>("Length")
      .smart_ptr_constructor("Length", &std::make_shared<LengthConstraint, EntityPtr, double>);
      // .constructor<EntityPtr, double>();

  class_<PointsCoincidentConstraint>("Coincident")
      .smart_ptr_constructor("Coincident", &std::make_shared<PointsCoincidentConstraint, std::shared_ptr<PointE>&, std::shared_ptr<PointE>&>);
      // .constructor<std::shared_ptr<PointE>&, std::shared_ptr<PointE>&>();

  class_<PointsDistanceConstraint, base<ValueConstraint>>("Distance")
      .smart_ptr_constructor("Distance", &std::make_shared<PointsDistanceConstraint, std::shared_ptr<PointE>&, std::shared_ptr<PointE>&, double>);
      // .constructor<std::shared_ptr<PointE>&, std::shared_ptr<PointE>&, double>()
      // .constructor<std::shared_ptr<LineE>&, double>();

  class_<AngleConstraint, base<ValueConstraint>>("Angle")
      .smart_ptr_constructor("Angle", &std::make_shared<AngleConstraint, std::shared_ptr<LineE>&, std::shared_ptr<LineE>&, double>);
      // .constructor<std::shared_ptr<LineE>&, std::shared_ptr<LineE>&, double>();

  class_<DiameterConstraint, base<ValueConstraint>>("Diameter")
      .smart_ptr_constructor("Diameter", &std::make_shared<DiameterConstraint, std::shared_ptr<Entity>&, double>);
  ...
  class_<HVConstraint, base<Constraint>>("HV")
      .smart_ptr_constructor("HV", &std::make_shared<HVConstraint, std::shared_ptr<LineE>, HVOrientation>)
  ...
  class_<ParallelConstraint, base<Constraint>>("Parallel")
      .smart_ptr_constructor("Parallel", &std::make_shared<ParallelConstraint, std::shared_ptr<LineE>&, std::shared_ptr<LineE>&>);
      // .constructor<std::shared_ptr<LineE>&, std::shared_ptr<LineE>&>();

  class_<TangentConstraint, base<Constraint>>("Tangent")
      .smart_ptr_constructor("Tangent", &std::make_shared<TangentConstraint, std::shared_ptr<CircleE>&, std::shared_ptr<LineE>&>);
  ...
  class_<ExpVector>("ExprVector")
      .smart_ptr_constructor("ExpVector", &std::make_shared<ExpVector, std::shared_ptr<Expr>&, std::shared_ptr<Expr>&, std::shared_ptr<Expr>&>)
